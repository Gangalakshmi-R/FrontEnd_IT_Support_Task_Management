  ...
  return(
   <Box sx={{ display: "flex", height: "calc(100vh - 60px)" }}>
      ...
      <Paper sx={{width:250,p:2,backgroundColor:"teal"}}>
        ...
        <List>
          <ListItem button selected={selectedSection==="employees"} onClick={()=>setSelectedSection("employees")}   sx={{ cursor: "pointer" }}>
            <PeopleIcon sx={{mr:1}}/>
            <ListItemText primary="Employees"/>
          </ListItem>

          <ListItem button selected={selectedSection==="technicians"} onClick={()=>setSelectedSection("technicians")}   sx={{ cursor: "pointer" }}>
            <EngineeringIcon sx={{mr:1}}/>
            <ListItemText primary="Technicians"/>
          </ListItem>

          <ListItem button selected={selectedSection==="issues"} onClick={()=>setSelectedSection("issues")}   sx={{ cursor: "pointer" }}>
